// Package zai provides Z.AI provider
package zai
...
func NewFromEnv() *Provider {
	...
	cfg := llm.Config{
		Type:    llm.ProviderZAi,
		APIKey:  apiKey,
		BaseURL: getEnv("ZAI_BASE_URL", "https://api.z-ai.com/v1"),
		Model:   getEnv("ZAI_MODEL", "default"),
		Timeout: 60,
	}
	return New(cfg)
}
...
func (p *Provider) Type() llm.ProviderType { return llm.ProviderZAi }
