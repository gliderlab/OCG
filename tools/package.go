// Package tools - OCG-Go tool invocation framework
//
...
func NewDefaultRegistry() *Registry {
	...
	// Gateway tool - Go-native implementation with GitHub releases support
	registry.Register(NewGatewayTool())
	registry.Register(&ProcessTool{})
	registry.Register(&WebSearchTool{})
	registry.Register(&WebFetchTool{})
	registry.Register(NewBrowserTool())
	// CanvasTool - skipped (requires node pairing, hard to test)
	// registry.Register(&CanvasTool{})
	// NodesTool - uses browser tool with UI key relay
